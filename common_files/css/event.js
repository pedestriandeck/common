    ...
    window.addEventListener('DOMContentLoaded', function () {
        ...
        for (let i = 0; i < tooltip.length; i++) {
            ...
            if (tooltip[i].classList.contains('c_tooltips01_top')) {
                triangle.style.bottom = -(trianglHeight) + 'px';
                textArea.style.top = (trianglHeight + IconHeight) + 'px';
            } else {
                triangle.style.top = -(trianglHeight) + 'px';
                textArea.style.bottom = (trianglHeight + IconHeight) + 'px';
            }
